        ...
        <div className="row">
          <div className="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-12">
            ...
            <h4 className="MType">Type of Shop:
              ...
              <button id="categories" className="btn btn-info btn-lg" onClick={this.props.addCategoryBtnClick}>Add</button>
            <h4 className="MType">Products for Sale:
              <ul>
              {goods}
              </ul></h4>
              <button id="goods" className="btn btn-info btn-lg" onClick={this.props.addGoodBtnClick}>Add</button>
